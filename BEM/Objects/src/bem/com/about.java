...
public class about extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "bem.com", "bem.com.about");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "bem.com", "bem.com.about");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "bem.com.about", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
anywheresoftware.b4a.objects.LabelWrapper _label1 = null;
 ...
 //BA.debugLineNum = 16;BA.debugLine="Activity.LoadLayout(\"about\")";
mostCurrent._activity.LoadLayout("about",mostCurrent.activityBA);
 //BA.debugLineNum = 19;BA.debugLine="For Each view1 As View In Activity.getallviewsrecu";
_view1 = new anywheresoftware.b4a.objects.ConcreteViewWrapper();
final anywheresoftware.b4a.BA.IterableList group7 = mostCurrent._activity.GetAllViewsRecursive();
final int groupLen7 = group7.getSize();
for (int index7 = 0;index7 < groupLen7 ;index7++){
_view1.setObject((android.view.View)(group7.Get(index7)));
 //BA.debugLineNum = 20;BA.debugLine="If view1 Is Label Then";
...
_label1 = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 22;BA.debugLine="Label1 = view1";
_label1.setObject((android.widget.TextView)(_view1.getObject()));
 //BA.debugLineNum = 23;BA.debugLine="Label1.typeface = Typeface.loadfromassets(\"yekan.t";
_label1.setTypeface(anywheresoftware.b4a.keywords.Common.Typeface.LoadFromAssets("yekan.ttf"));
 //BA.debugLineNum = 24;BA.debugLine="Label1.TextColor=Colors.White";
...
if (_keycode==anywheresoftware.b4a.keywords.Common.KeyCodes.KEYCODE_BACK) { 
 //BA.debugLineNum = 41;BA.debugLine="StartActivity(main3)";

...
views.get("button1").vw.setHeight((int)((12d / 100 * height)));
views.get("button2").vw.setTop((int)((views.get("label5").vw.getTop())+(3d / 100 * height)+(views.get("label5").vw.getHeight())));
views.get("button2").vw.setLeft((int)((55d / 100 * width)));
views.get("button2").vw.setWidth((int)((40d / 100 * width)));
views.get("button2").vw.setHeight((int)((12d / 100 * height)));

...
public class about1 extends Activity implements B4AActivity{
	public static about1 mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "bem.com", "bem.com.about1");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (about1).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "bem.com", "bem.com.about1");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "bem.com.about1", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (about1) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (about1) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (about1) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
anywheresoftware.b4a.objects.LabelWrapper _label1 = null;
 ...
 //BA.debugLineNum = 15;BA.debugLine="Activity.LoadLayout(\"about\")";
mostCurrent._activity.LoadLayout("about",mostCurrent.activityBA);
 //BA.debugLineNum = 18;BA.debugLine="For Each view1 As View In Activity.getallviewsrecu";
...
_view1.setObject((android.view.View)(group6.Get(index6)));
 //BA.debugLineNum = 19;BA.debugLine="If view1 Is Label Then";
...
_label1 = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 21;BA.debugLine="Label1 = view1";
_label1.setObject((android.widget.TextView)(_view1.getObject()));
 //BA.debugLineNum = 22;BA.debugLine="Label1.typeface = Typeface.loadfromassets(\"yekan.t";
_label1.setTypeface(anywheresoftware.b4a.keywords.Common.Typeface.LoadFromAssets("yekan.ttf"));
 //BA.debugLineNum = 23;BA.debugLine="Label1.TextColor=Colors.White";
...
if (_keycode==anywheresoftware.b4a.keywords.Common.KeyCodes.KEYCODE_BACK) { 
 //BA.debugLineNum = 40;BA.debugLine="StartActivity(main2)";

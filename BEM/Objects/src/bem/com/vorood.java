...
public class vorood extends Activity implements B4AActivity{
	public static vorood mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "bem.com", "bem.com.vorood");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (vorood).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "bem.com", "bem.com.vorood");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "bem.com.vorood", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (vorood) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (vorood) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (vorood) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
anywheresoftware.b4a.objects.LabelWrapper _label1 = null;
 ...
 //BA.debugLineNum = 23;BA.debugLine="Activity.LoadLayout(\"vorood\")";
mostCurrent._activity.LoadLayout("vorood",mostCurrent.activityBA);
 //BA.debugLineNum = 26;BA.debugLine="For Each view1 As View In Activity.getallviewsrecu";
...
_view1.setObject((android.view.View)(group15.Get(index15)));
 //BA.debugLineNum = 27;BA.debugLine="If view1 Is Label Then";
...
_label1 = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 29;BA.debugLine="Label1 = view1";
_label1.setObject((android.widget.TextView)(_view1.getObject()));
 //BA.debugLineNum = 30;BA.debugLine="Label1.typeface = Typeface.loadfromassets(\"yekan.t";
_label1.setTypeface(anywheresoftware.b4a.keywords.Common.Typeface.LoadFromAssets("yekan.ttf"));
 //BA.debugLineNum = 31;BA.debugLine="Label1.TextColor=Colors.White";
_label1.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 };
 }
;
 //BA.debugLineNum = 35;BA.debugLine="If File.exists(File.dirinternal,\"bemdb.db\") = True";
if (anywheresoftware.b4a.keywords.Common.File.Exists(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),"bemdb.db")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 36;BA.debugLine="File.copy(File.dirassets,\"bemdb.db\",File.dirinte";
anywheresoftware.b4a.keywords.Common.File.Copy(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"bemdb.db",anywheresoftware.b4a.keywords.Common.File.getDirInternal(),"bemdb.db");
 ...
 //BA.debugLineNum = 38;BA.debugLine="sq.Initialize(File.DirInternal,\"bemdb.db\",False)";
_sq.Initialize(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),"bemdb.db",anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 39;BA.debugLine="ht.Initialize(\"Register\",Me)";
mostCurrent._ht._initialize(processBA,"Register",vorood.getObject());
...
if (_keycode==anywheresoftware.b4a.keywords.Common.KeyCodes.KEYCODE_BACK) { 
 //BA.debugLineNum = 81;BA.debugLine="StartActivity(ozveyat)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._ozveyat.getObject()));
...
String _go = "";
 ...
 //BA.debugLineNum = 69;BA.debugLine="Dim go As String";
_go = "";
 //BA.debugLineNum = 70;BA.debugLine="go = \"&name=\"&EditText1.Text&\"&fname=\"&EditText2.";
_go = "&name="+mostCurrent._edittext1.getText()+"&fname="+mostCurrent._edittext2.getText()+"&username="+mostCurrent._edittext3.getText()+"&pass="+mostCurrent._edittext4.getText();
 //BA.debugLineNum = 71;BA.debugLine="ht.PostString(\"http://bemq.ir/vorood.php\",go)";
mostCurrent._ht._poststring("http://bemq.ir/vorood.php",_go);
 //BA.debugLineNum = 72;BA.debugLine="ProgressDialogShow(\"Please Wait ...\")";
...
public static String  _button2_click() throws Exception{
 ...
 //BA.debugLineNum = 76;BA.debugLine="StartActivity(ozveyat)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._ozveyat.getObject()));
...
public static String  _globals() throws Exception{
 ...
 //BA.debugLineNum = 11;BA.debugLine="Dim ht As HttpJob";
...
mostCurrent._edittext1 = new anywheresoftware.b4a.objects.EditTextWrapper();
 //BA.debugLineNum = 15;BA.debugLine="Private EditText2 As EditText";
mostCurrent._edittext2 = new anywheresoftware.b4a.objects.EditTextWrapper();
 //BA.debugLineNum = 16;BA.debugLine="Private EditText3 As EditText";
mostCurrent._edittext3 = new anywheresoftware.b4a.objects.EditTextWrapper();
 //BA.debugLineNum = 17;BA.debugLine="Private EditText4 As EditText";
...
if (_job._success==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 54;BA.debugLine="If job.JobName=\"Register\" Then";
if ((_job._jobname).equals("Register")) { 
 //BA.debugLineNum = 56;BA.debugLine="ProgressDialogHide";
anywheresoftware.b4a.keywords.Common.ProgressDialogHide();
 //BA.debugLineNum = 57;BA.debugLine="Msgbox(job.GetString,\"Come\")";
anywheresoftware.b4a.keywords.Common.Msgbox(_job._getstring(),"Come",mostCurrent.activityBA);
 };
 }else {
 //BA.debugLineNum = 62;BA.debugLine="ToastMessageShow(\"Error During Connecting\",False";
